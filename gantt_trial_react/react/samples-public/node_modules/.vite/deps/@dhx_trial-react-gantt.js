...
// node_modules/@dhx/trial-react-gantt/dist/dhtmlxgantt.react.es.js
...
var Jt;
var V = ((t) => (t.ASAP = "asap", t.ALAP = "alap", t.SNET = "snet", t.SNLT = "snlt", t.FNET = "fnet", t.FNLT = "fnlt", t.MSO = "mso", t.MFO = "mfo", t))(V || {});
var Pt = class _Pt {
  static Create(n) {
    const e = new _Pt();
...
var Rn = Object.freeze(Object.defineProperty({ __proto__: null, addClassName: $t, closest: ct, getActiveElement: De, getChildNodes: Mn, getClassName: it, getClosestSizedElement: Nn, getFocusableNodes: Vt, getNodePosition: J, getRelativeEventPosition: dt, getRelativeNodePosition: Ln, getRootNode: Et, getScrollSize: An, getTargetNode: At, hasClass: function(t, n) {
  ...
  return !!Et(t);
}, insertNode: Dn, isChildOf: Q, isShadowDomSupported: Pn, locateAttribute: et, locateClassName: kt, removeClassName: Nt, removeNode: In, toNode: Ve }, Symbol.toStringTag, { value: "Module" }));
var q = typeof window < "u" ? window : global;
var ki = class {
  constructor(t) {
...
var zn = Object.freeze(Object.defineProperty({ __proto__: null, bind: j, copy: K, defined: U, event: On, eventRemove: Bn, mixin: H, uid: ut }, Symbol.toStringTag, { value: "Module" }));
function jn(t) {
  var n = t.date;
...
var an = { onBeforeUndo: "onAfterUndo", onBeforeRedo: "onAfterRedo" };
var sn = ["onTaskDragStart", "onAfterTaskUpdate", "onAfterParentExpand", "onAfterTaskDelete", "onBeforeBatchUpdate"];
var Ti = class {
  constructor(n, e) {
...
var Ei = { auto_scheduling: function(t) {
...
var Ai = { KEY_CODES: { UP: 38, DOWN: 40, LEFT: 37, RIGHT: 39, SPACE: 32, ENTER: 13, DELETE: 46, ESC: 27, TAB: 9 } };
var vt = typeof window < "u";
var gt = typeof navigator < "u" ? navigator : { userAgent: "" };
...
var ln = { date_to_str: (t, n, e) => (i) => t.replace(/%[a-zA-Z]/g, (a) => {
  switch (a) {
    case "%d":
...
var Me = { getSubtreeLinks: function(t, n) {
  var e = {};
...
var zt = { isLegacyResourceCalendarFormat: function(t) {
  if (!t) return false;
...
var da = (Kt = {}, { getCalendarIdFromMultipleResources: function(t, n) {
  var e = function(a) {
...
var nt = { createDropTargetObject: function(t) {
...
var wn = { removeLineHighlight: function(t) {
...
var Vs = ["ctrlKey", "altKey", "shiftKey", "metaKey"];
var Us = [[{ unit: "month", date: "%M", step: 1 }, { unit: "day", date: "%d", step: 1 }], [{ unit: "day", date: "%d %M", step: 1 }], [{ unit: "day", date: "%d %M", step: 1 }, { unit: "hour", date: "%H:00", step: 8 }], [{ unit: "day", date: "%d %M", step: 1 }, { unit: "hour", date: "%H:00", step: 1 }]];
var Gs = class {
  constructor(n) {
    this.zoomIn = () => {
...
function renderToString(element) {
  if (ReactDOMClient.createRoot) {
    ...
    if (import_react_dom.default.flushSync) {
      import_react_dom.default.flushSync(() => root2.render(element));
    } else {
  ...
  queueMicrotask(() => import_react_dom.default.unmountComponentAtNode(container));
  return html;
}
function createGanttTemplateInterceptor(portalRegistry) {
  ...
  return function ganttTemplateInterceptor(ganttInstance, templateWrapper, imperativeRef) {
    ...
    ganttInstance.config.external_render = {
      isElement: (element) => {
        return import_react.default.isValidElement(element);
      },
...
function PortalManager({ portalRegistryRef }) {
  const [portals, setPortals] = (0, import_react.useState)([]);
  ...
  return (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: portals.map(([id, element]) => {
    const container = document.getElementById(id);
    if (!container) {
      return null;
    }
    ...
    return (0, import_jsx_runtime.jsx)(import_react.default.Fragment, { children: import_react_dom.default.createPortal(element, container) }, id);
  }) });
}
var PortalRegistry = class {
  constructor() {
...
function useConfig(ganttRef, prevConfigRef, config, debounceRender, debounceInit) {
  const prevLayoutRef = (0, import_react.useRef)(null);
  (0, import_react.useEffect)(() => {
    const gantt2 = ganttRef.current;
    if (!gantt2) return;
...
var PortalBridge = function InlineEditorBridge({
  editor,
  EditorComponent,
  onUnmount
}) {
  ...
  return import_react_dom.default.createPortal(
    (0, import_jsx_runtime.jsx)(EditorComponent, { ref: editorRef, initialValue, task, save, cancel, ganttInstance }),
    placeholder
  );
};
var InlineEditorsManager = import_react.default.memo(
  ({ activeEditors, inlineEditors, closeEditor, ganttInstance }) => {
    return (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: activeEditors.map((editor) => (0, import_jsx_runtime.jsx)(
      PortalBridge,
      {
        editor: {
          ...editor,
...
var debounceCalls = (initCallback, renderCallback) => {
...
var ReactWrapper = (0, import_react.forwardRef)(function ReactGantt({
  tasks = [],
  links = [],
  calendars = null,
  resources = null,
  ...
  const ganttContainer = (0, import_react.useRef)(null);
  const internalInstance = (0, import_react.useRef)(null);
  const templatesProxifier = (0, import_react.useRef)(null);
  const previousConfig = (0, import_react.useRef)(null);
  const previousTemplates = (0, import_react.useRef)(null);
  const prevTasks = (0, import_react.useRef)(null);
  const prevLinks = (0, import_react.useRef)(null);
  const prevResources = (0, import_react.useRef)(null);
  const prevResourceAssignments = (0, import_react.useRef)(null);
  const prevBaselines = (0, import_react.useRef)(null);
  const prevMarkers = (0, import_react.useRef)(null);
  const prevFilter = (0, import_react.useRef)(null);
  const prevResourceFilter = (0, import_react.useRef)(null);
  const prevGroupTasks = (0, import_react.useRef)(null);
  const portalRegistryRef = (0, import_react.useRef)(new PortalRegistry());
  const [activeEditors, setActiveEditors] = (0, import_react.useState)([]);
  ...
  return (0, import_jsx_runtime.jsxs)("div", { style: { height: "100%", minHeight: "200px" }, className: ["react-gantt-container", className || ""].filter(Boolean).join(" "), children: [
    (0, import_jsx_runtime.jsx)("div", { ref: ganttContainer, style: { width: "100%", height: "100%" } }),
    (0, import_jsx_runtime.jsx)(PortalManager, { portalRegistryRef }),
    customLightbox && lightboxData && import_react.default.cloneElement(customLightbox, {
...
@dhx/trial-react-gantt/dist/dhtmlxgantt.react.es.js:
  (** @license
  ...
  *)
*/
//# sourceMappingURL=@dhx_trial-react-gantt.js.map
