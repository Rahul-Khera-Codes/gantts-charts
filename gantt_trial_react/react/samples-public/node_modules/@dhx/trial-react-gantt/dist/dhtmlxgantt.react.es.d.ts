...
interface GanttInitializationConfig {
...
interface GanttStatic {
	...
	*/
	calculateDuration: Calendar$1["calculateDuration"];
	...
	*/
	calculateEndDate: Calendar$1["calculateEndDate"];
	...
	*/
	createCalendar(parentCalendar?: Calendar$1): Calendar$1;
	...
	*/
	getCalendar(calendarId?: string | number): Calendar$1;
	...
	*/
	getClosestWorkTime: Calendar$1["getClosestWorkTime"];
	...
	*/
	isWorkTime: Calendar$1["isWorkTime"];
	...
	*/
	mergeCalendars(calendars: Calendar$1[] | Calendar$1, calendar2?: Calendar$1): void;
	...
	*/
	setWorkTime: Calendar$1["setWorkTime"];
	...
	*/
	 ...
	 * @param config the configuration object of a time span
	*/
	unsetWorkTime: Calendar$1["unsetWorkTime"];
...
interface LightboxSectionState {
...
interface ScaleArray<ScaleObj> extends Array<ScaleObj> {
	0: ScaleObj
}

type Scales = ScaleArray<Scale>;
...
type WorkDayConfig = string | number | boolean | Array<string | number>
...
*/
type UndoRedoAction = { commands: UndoRedoCommand[] }
...
interface TreeDatastoreMethods extends DatastoreMethods {
...
interface TreeDatastoreEvents extends DatastoreEvents {
...
interface InlineEditorMethods$1 {
	...
	*/
	setMapping(
		mapping: {
			init: ((
				inlineEditors: InlineEditorMethods$1,
				grid: any,
			) => void),
			onShow: ((
				inlineEditors: InlineEditorMethods$1,
...
type TaskFilter = ((Task: any) => boolean) | null;

type ResourceFilter = (resource: any) => boolean;
...
interface CalendarDays {
    weekdays?: Partial<Record<WeekDay, string[] | boolean>> | WorkDaysTuple;
...
interface ReactGanttTemplates extends Partial<Omit<GanttTemplates, 'baseline_text' | 'date_grid' | 'drag_link' | 'drag_link_class' | 'format_date' | 'grid_blank' | 'grid_date_format' | 'grid_file' | 'grid_folder' | 'grid_header_class' | 'grid_indent' | 'grid_open' | 'grid_row_class' | 'histogram_cell_allocated' | 'histogram_cell_capacity' | 'histogram_cell_class' | 'histogram_cell_label' | 'link_class' | 'link_description' | 'parse_date' | 'progress_text' | 'quick_info_class' | 'quick_info_content' | 'quick_info_date' | 'quick_info_title' | 'resource_cell_class' | 'resource_cell_value' | 'scale_cell_class' | 'scale_row_class' | 'task_class' | 'task_date' | 'task_end_date' | 'task_row_class' | 'task_text' | 'task_time' | 'task_unscheduled_time' | 'time_picker' | 'timeline_cell_class' | 'timeline_cell_content' | 'tooltip_date_format' | 'tooltip_text' | 'rightside_text' | 'leftside_text' | 'lightbox_header' | 'marker_class'>> {
    /**
...
type OnBeforeTaskDeleteConfirm = (args: OnBeforeTaskDeleteConfirmArgs) => void;
type OnBeforeLinkDeleteConfirm = (args: OnBeforeLinkDeleteConfirmArgs) => void;
...
interface SerializedLink {
    ...
    */
    lag?: number;
    /**
     * Defines whether the link can be editable in the read-only Gantt chart
    */
    editable?: boolean;
    /**
     * Defines whether the link must be readonly
    */
    readonly?: boolean;
    [customProperty: string]: any;
}

interface InlineEditorMethods {
    getValue: () => any;
...
interface InlineEditorProps extends EditorComponentProps {
    ref?: React$1.Ref<InlineEditorMethods>;
}

declare function useWorkTime(ganttRef: React.RefObject<ReactGanttRef>): {
...
declare function useResourceAssignments(ganttRef: React.RefObject<ReactGanttRef>): {
    getResourceAssignments(resourceId: string | number, taskId?: string | number): ResourceAssignment[];
    getTaskResources(taskId: string | number): ResourceItem[];
};

declare function useGanttDatastore<T>(ganttRef: React.RefObject<ReactGanttRef>, storeName: string): {
...
type GanttConfig = Partial<GanttConfigOptions>;

interface ReactGanttProps {
    tasks?: Task[];
    links?: Link[];
    calendars?: Calendar[] | CalendarConfig[];
    resources?: any[];
    baselines?: any;
    ...
    *   )
    */
    templateWrapper?: (element: React$1.ReactElement) => React$1.ReactElement;
    [key: string]: any;
}
declare const ReactWrapper: React$1.ForwardRefExoticComponent<Omit<ReactGanttProps, "ref"> & React$1.RefAttributes<any>>;

export { Gantt, ReactWrapper as default, gantt, useGanttDatastore, useResourceAssignments, useWorkTime };
export type { AdditionalLinkLayer, AdditionalTaskLayer, AlertBoxConfig, AutoSchedulingConfig, Baseline, BaselineConfig, BatchChanges, Calendar, CalendarConfig, ClickDrag, ConfirmBoxConfig, CustomObject, CustomTypeRenderers, DataCallbackChange, DataProcessorConfig, DataToLoad1, DataToLoad2, DatastoreConfig, DatastoreEvents, DatastoreMethods, DateHelpers, DomHelpers, DurationFormatter, EmptyState, Ext, Formatters, Fullscreen, GanttConfig, GanttConfigOptions, GanttEnterprise, GanttEventCallback, GanttHotkeys, GanttInitializationConfig, GanttInternationalization, GanttLocale, GanttLocaleDate, GanttLocaleLabels, GanttModals, GanttPlugin, GanttPlugins, GanttStatic, ReactGanttTemplates as GanttTemplates, GanttUIState, GridColumn, GroupConfig, HandlerSettings, InlineEditor, InlineEditorEvents, InlineEditorMethods, InlineEditorProps, KeyNav, LightboxControl, LightboxSection, LightboxSectionState, LightboxSections, Link, LinkForValidation, LinkFormatter, Marker, MarkerConfig, MessagePopupConfig, MessagePopupObject, ModalBoxConfig, ModalboxButton, MonthLabelList, NewAssignmentItem, NewResourceItem, NewTask, OnBeforeLinkDeleteConfirm, OnBeforeLinkDeleteConfirmArgs, OnBeforeTaskDeleteConfirm, OnBeforeTaskDeleteConfirmArgs, Overlay, QuickInfo, ReactGanttProps, ReactGanttRef, ResourceAssignment, ResourceItem, RoundDateConfig, RouterConfig, RouterForEntity, RouterFunction, Scale, ScaleArray, ScaleProjectionMode, Scales, SerializedLink, SerializedTask, Task, TaskFilter as TaskFilteringFunction, Tooltip, Tooltips, TreeDatastoreEvents, TreeDatastoreMethods, Undo, UndoRedoAction, UndoRedoCommand, WeekDayLabelList, WorkDayConfig, WorkDaysSettings, WorkDaysTuple, ZoomEvents, ZoomLevel, ZoomMethods, СollectionItem, Сollections };
